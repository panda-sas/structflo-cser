...
STRAY_FRAGMENTS = [
    # Journal / DOI refs
    "J Med Chem",
    "J Med Chem 2024, 67, 1234–1251",
    "DOI:10.1000/xyz",
    "DOI:10.1021/acs.jmedchem.4c00123",
    "DOI:10.1016/j.ejmech.2024.116412",
    "DOI:10.1039/d4md00321g",
    "Bioorg Med Chem Lett",
    "Eur J Med Chem 2023, 258, 115584",
    "ACS Med Chem Lett",
    "Drug Discov Today 2024, 29, 103891",
    "ChemMedChem 2023, 18, e202300201",
    "Nat Chem Biol 2024",
    "JACS 2024, 146, 8912",
    "Org Lett 2024, 26, 3412",
    # NMR data
    ...
    "bp 78 °C (0.5 mmHg)",
    "[α]D = -23.5",
    "[α]D20 = +14.2 (c 1.0, MeOH)",
    "[α]D25 = -8.7 (c 0.5, CHCl3)",
    "Rf = 0.45 (EtOAc/hexane 3:7)",
    "Rf = 0.32 (DCM/MeOH 9:1)",
    # Compound metadata
    "HPLC purity >95%",
    "HPLC purity >98% (UV 254 nm)",
    "purity: 97.3% (ELSD)",
    ">99% ee (chiral HPLC)",
    "ee = 96%",
    "dr = 9:1",
    ...
    "See CHEMBL4051 for details",
    "ZINC00123456 (inactive)",
    "Ref: PUBCHEM2341157",
    "cf. MCULE-1234567",
    "CPD-00441 showed no activity",
    "data from MOL-98231",
    "activity vs. ENAMINE-T001",
    "HIT-00923 excluded",
    "IC50 values: STD-00001–STD-00010",
    "Selected from ZINC library",
    "PUBCHEM CID: 44259",
    "CHEMBL dataset ver. 33",
    "cross-ref: ZINC15",
    "ChEMBL ID: 2109628",
    "see MCULE catalog entry",
    "CPD-03341 not tested",
    "inactive: MOL-00023",
    "from ENAMINE stock",
    "see also HIT-04410",
    # Analytical conditions
    "Method A: 5–95% MeCN over 2 min",
    "Gradient: H2O/MeCN 10–90%",
    "Column: C18, 2.1 × 50 mm, 1.7 µm",
    "Flow rate: 1.5 mL/min",
    "UV detection at 214 nm",
    "ELSD detection",
    "PDA detector",
    "Column: BEH C18, 50 × 2.1 mm",
    "run time: 3.5 min",
    # Internal document markers
    "Draft v1.3 — Do Not Distribute",
    "INTERNAL USE ONLY",
    "Compound Registration #CR-2024-0891",
    "CRO: Evotec",
    "Project: ONC-2024",
    "Batch: 2024-BCH-0042",
    "Notebook: ELN-44321, page 87",
    "Analyst: J. Smith",
    "Reviewed by: QC Dept.",
    "Approved: 2025-01-15",
    "Study ID: PK-2024-0087",
    "Protocol: TOX-2024-113",
    # Other stray text
    ...
    "Prepared by: Discovery Chemistry",
    "CAS No. 50-78-2",
...
def add_rgroup_table(
    ...
    for i in range(cols + 1):
        draw.line(
            (x0 + i * cell_w, y0, x0 + i * cell_w, y0 + rows * cell_h),
            fill=(0, 0, 0),
            width=1,
        )
    for j in range(rows + 1):
        draw.line(
            (x0, y0 + j * cell_h, x0 + cols * cell_w, y0 + j * cell_h),
            fill=(0, 0, 0),
            width=1,
        )
...
def add_footnote(
    ...
    for _ in range(30):
        ...
        y0 = random.randint(
            max(cfg.margin, h * 3 // 4), max(cfg.margin, h - cfg.margin - th)
        )
